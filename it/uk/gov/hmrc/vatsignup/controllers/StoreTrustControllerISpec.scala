...
class StoreTrustControllerISpec extends ComponentSpecBase with CustomMatchers with TestSubmissionRequestRepository {

  "POST /subscription-request/vat-number/:vatNumber/trust" should {
    "return NO_CONTENT" in {
      ...
      dbRequest.businessEntity shouldBe Some(Trust)
    }
  }
}
