...
class StoreAdministrativeDivisionControllerISpec extends ComponentSpecBase with CustomMatchers with TestSubmissionRequestRepository {

  "POST /subscription-request/vat-number/:vatNumber/administrative-division" should {
    "return NO_CONTENT" in {
      ...
      dbRequest.businessEntity shouldBe Some(AdministrativeDivision)
    }
  }
}
