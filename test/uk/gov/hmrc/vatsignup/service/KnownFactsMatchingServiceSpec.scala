...
class KnownFactsMatchingServiceSpec extends WordSpec with Matchers with FeatureSwitching
  ...
  val testEnteredFourKnownFacts: VatKnownFacts = VatKnownFacts(
  ...
  val testLastNetDueNegative: String = (testLastNetDue.toDouble * -1).toString

  val testEnteredKnownFactsNegativeBox5: VatKnownFacts = VatKnownFacts(
