...
import uk.gov.hmrc.vatsignup.services.StorePartnershipUtrService
import uk.gov.hmrc.vatsignup.services.StorePartnershipUtrService.{PartnershipUtrDatabaseFailure, PartnershipUtrDatabaseFailureNoVATNumber, StorePartnershipUtrSuccess}

import scala.concurrent.ExecutionContext.Implicits.global
import scala.concurrent.Future

class StorePartnershipUtrServiceSpec extends UnitSpec
  with MockSubscriptionRequestRepository {

  object TestStorePartnershipUtrService extends StorePartnershipUtrService(
  ...
  "storePartnershipUtr" when {
    "upsertPartnershipUtr is successful" should {
      "return StorePartnershipUtrSuccess" in {
        ...
        val res = TestStorePartnershipUtrService.storePartnershipUtr(testVatNumber, GeneralPartnership, testUtr)
