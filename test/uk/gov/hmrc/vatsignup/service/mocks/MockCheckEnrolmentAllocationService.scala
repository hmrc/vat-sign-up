...
import uk.gov.hmrc.vatsignup.services.CheckEnrolmentAllocationService.CheckEnrolmentAllocationResponse

import scala.concurrent.Future

trait MockCheckEnrolmentAllocationService extends BeforeAndAfterEach with MockitoSugar {
  this: Suite =>
  ...
  def mockGetGroupIdForMtdVatEnrolment(vatNumber: String, ignoreAssignments: Boolean)(response: Future[CheckEnrolmentAllocationResponse]): Unit = {
