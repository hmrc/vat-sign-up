...
trait MockRequestIdService extends MockitoSugar with BeforeAndAfterEach {
  self: Suite =>

  val mockRequestIdService: RequestIdService = mock[RequestIdService]

  override def beforeEach(): Unit = {
    super.beforeEach()
    reset(mockRequestIdService)
  }
