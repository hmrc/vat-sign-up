...
import uk.gov.hmrc.vatsignup.helpers.TestConstants.{ControlList34, ControlList35}
  ...
  "ControlListInformation.tryParse" should {
    "parse into a ControlListInformation object" when {
      "the string is valid" in {
        ...
        tryParse(ControlList35.valid).isRight shouldBe true
      }
      ...
      "the string is valid and" should {
        "parse below VAT threshold correctly" in {
          ...
          tryParse(ControlList35.setupTestData(BELOW_VAT_THRESHOLD -> '0')).right.value.controlList should contain(BelowVatThreshold)
          tryParse(ControlList35.setupTestData(BELOW_VAT_THRESHOLD -> '1')).right.value.controlList should not contain BelowVatThreshold
        }
        ...
        "parse missing returns correctly" in {
          ...
          tryParse(ControlList35.setupTestData(MISSING_RETURNS -> '0')).right.value.controlList should contain(MissingReturns)
          tryParse(ControlList35.setupTestData(MISSING_RETURNS -> '1')).right.value.controlList should not contain MissingReturns
        }
        ...
        "parse central assessments correctly" in {
          ...
          tryParse(ControlList35.setupTestData(CENTRAL_ASSESSMENTS -> '0')).right.value.controlList should contain(CentralAssessments)
          tryParse(ControlList35.setupTestData(CENTRAL_ASSESSMENTS -> '1')).right.value.controlList should not contain CentralAssessments
        }
        ...
        "parse criminal investigation inhibits correctly" in {
          ...
          tryParse(ControlList35.setupTestData(CRIMINAL_INVESTIGATION_INHIBITS -> '0')).right.value.controlList should contain(CriminalInvestigationInhibits)
          tryParse(ControlList35.setupTestData(CRIMINAL_INVESTIGATION_INHIBITS -> '1')).right.value.controlList should not contain CriminalInvestigationInhibits
        }
        ...
        "parse compliance penalities or surcharges correctly" in {
          ...
          tryParse(ControlList35.setupTestData(COMPLIANCE_PENALTIES_OR_SURCHARGES -> '0')).right.value.controlList should contain(CompliancePenaltiesOrSurcharges)
          tryParse(ControlList35.setupTestData(COMPLIANCE_PENALTIES_OR_SURCHARGES -> '1')).right.value.controlList should not contain CompliancePenaltiesOrSurcharges
        }
        ...
        "parse insolvency correctly" in {
          ...
          tryParse(ControlList35.setupTestData(INSOLVENCY -> '0')).right.value.controlList should contain(Insolvency)
          tryParse(ControlList35.setupTestData(INSOLVENCY -> '1')).right.value.controlList should not contain Insolvency
        }
        ...
        "parse de-reg/death correctly" in {
          ...
          tryParse(ControlList35.setupTestData(DEREG_OR_DEATH -> '0')).right.value.controlList should contain(DeRegOrDeath)
          tryParse(ControlList35.setupTestData(DEREG_OR_DEATH -> '1')).right.value.controlList should not contain DeRegOrDeath
        }
        ...
        "parse debt migration correctly" in {
          ...
          tryParse(ControlList35.setupTestData(DEBT_MIGRATION -> '0')).right.value.controlList should contain(DebtMigration)
          tryParse(ControlList35.setupTestData(DEBT_MIGRATION -> '1')).right.value.controlList should not contain DebtMigration
        }
        ...
        "parse direct debit correctly" in {
          ...
          tryParse(ControlList35.setupTestData(DIRECT_DEBIT -> '0')).right.value.controlList should contain(DirectDebit)
          tryParse(ControlList35.setupTestData(DIRECT_DEBIT -> '1')).right.value.controlList should not contain DirectDebit
        }
        ...
        "parse large business correctly" in {
          ...
          tryParse(ControlList35.setupTestData(LARGE_BUSINESS -> '0')).right.value.controlList should contain(LargeBusiness)
          tryParse(ControlList35.setupTestData(LARGE_BUSINESS -> '1')).right.value.controlList should not contain LargeBusiness
        }
        ...
        "parse missing trader correctly" in {
          ...
          tryParse(ControlList35.setupTestData(MISSING_TRADER -> '0')).right.value.controlList should contain(MissingTrader)
          tryParse(ControlList35.setupTestData(MISSING_TRADER -> '1')).right.value.controlList should not contain MissingTrader
        }
        ...
        "parse EU sales/purchases  correctly" in {
          ...
          tryParse(ControlList35.setupTestData(EU_SALES_OR_PURCHASES -> '0')).right.value.controlList should contain(EuSalesOrPurchases)
          tryParse(ControlList35.setupTestData(EU_SALES_OR_PURCHASES -> '1')).right.value.controlList should not contain EuSalesOrPurchases
        }
        ...
        "parse Stagger without none standard tax period  correctly" in {
          ...
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', ANNUAL_STAGGER -> '0')).right.value.controlList should contain(AnnualStagger)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', MONTHLY_STAGGER -> '0')).right.value.controlList should contain(MonthlyStagger)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '0')).right.value.controlList should contain(Stagger1)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', STAGGER_2 -> '0')).right.value.controlList should contain(Stagger2)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', STAGGER_3 -> '0')).right.value.controlList should contain(Stagger3)
        }
        ...
        "parse Stagger with none standard tax period correctly" in {
          ...
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', NONE_STANDARD_TAX_PERIOD -> '0')).right.value.controlList should contain(NonStandardTaxPeriod)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '0', NONE_STANDARD_TAX_PERIOD -> '0')).right.value.controlList should contain(Stagger1)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', STAGGER_2 -> '0', NONE_STANDARD_TAX_PERIOD -> '0')).right.value.controlList should contain(Stagger2)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', STAGGER_3 -> '0', NONE_STANDARD_TAX_PERIOD -> '0')).right.value.controlList should contain(Stagger3)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', ANNUAL_STAGGER -> '0', NONE_STANDARD_TAX_PERIOD -> '0')).right.value.controlList should contain(AnnualStagger)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', MONTHLY_STAGGER -> '0', NONE_STANDARD_TAX_PERIOD -> '0')).right.value.controlList should contain(MonthlyStagger)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', NONE_STANDARD_TAX_PERIOD -> '1')) shouldBe Left(StaggerConflict)
          tryParse(ControlList35.setupTestData(STAGGER_1 -> '1', ANNUAL_STAGGER -> '0', MONTHLY_STAGGER -> '0', NONE_STANDARD_TAX_PERIOD -> '0')) shouldBe Left(StaggerConflict)
        }
        ...
        "parse over seas trader correctly" in {
          ...
          tryParse(ControlList35.setupTestData(OVERSEAS_TRADER -> '0')).right.value.controlList should contain(OverseasTrader)
          tryParse(ControlList35.setupTestData(OVERSEAS_TRADER -> '1')).right.value.controlList should not contain OverseasTrader
        }
        ...
        "parse POA trader correctly" in {
          ...
          tryParse(ControlList35.setupTestData(POA_TRADER -> '0')).right.value.controlList should contain(PoaTrader)
          tryParse(ControlList35.setupTestData(POA_TRADER -> '1')).right.value.controlList should not contain PoaTrader
        }
        ...
        "parse Business Entity correctly" in {
          ...
          tryParse(ControlList35.setupTestData(COMPANY -> '0')).right.value.controlList should contain(Company)
          tryParse(ControlList35.setupTestData(COMPANY -> '1', DIVISION -> '0')).right.value.controlList should contain(Division)
          tryParse(ControlList35.setupTestData(COMPANY -> '1', GROUP -> '0')).right.value.controlList should contain(Group)
          tryParse(ControlList35.setupTestData(COMPANY -> '0', GROUP -> '0')).right.value.controlList should contain(Group)
          tryParse(ControlList35.setupTestData(COMPANY -> '1', PARTNERSHIP -> '0')).right.value.controlList should contain(Partnership)
          tryParse(ControlList35.setupTestData(COMPANY -> '1', PUBLIC_CORPORATION -> '0')).right.value.controlList should contain(PublicCorporation)
          tryParse(ControlList35.setupTestData(COMPANY -> '1', SOLE_TRADER -> '0')).right.value.controlList should contain(SoleTrader)
          tryParse(ControlList35.setupTestData(COMPANY -> '1', LOCAL_AUTHORITY -> '0')).right.value.controlList should contain(LocalAuthority)
          tryParse(ControlList35.setupTestData(COMPANY -> '1', NON_PROFIT -> '0')).right.value.controlList should contain(NonProfitMakingBody)
        }
        ...
        "parse DIFIC trader correctly" in {
          ...
          tryParse(ControlList35.setupTestData(DIFIC_TRADER -> '0')).right.value.controlList should contain(DificTrader)
          tryParse(ControlList35.setupTestData(DIFIC_TRADER -> '1')).right.value.controlList should not contain DificTrader
        }
        ...
        "parse anything under appeal correctly" in {
          ...
          tryParse(ControlList35.setupTestData(ANYTHING_UNDER_APPEAL -> '0')).right.value.controlList should contain(AnythingUnderAppeal)
          tryParse(ControlList35.setupTestData(ANYTHING_UNDER_APPEAL -> '1')).right.value.controlList should not contain AnythingUnderAppeal
        }
        ...
        "parse repayment trader correctly" in {
          ...
          tryParse(ControlList35.setupTestData(REPAYMENT_TRADER -> '0')).right.value.controlList should contain(RepaymentTrader)
          tryParse(ControlList35.setupTestData(REPAYMENT_TRADER -> '1')).right.value.controlList should not contain RepaymentTrader
        }
        ...
        "parse MOSS trader correctly" in {
          ...
          tryParse(ControlList35.setupTestData(MOSS_TRADER -> '0')).right.value.controlList should contain(MossTrader)
          tryParse(ControlList35.setupTestData(MOSS_TRADER -> '1')).right.value.controlList should not contain MossTrader
        }
        ...
        "parse Flat rate correctly" in {
          ...
          tryParse(ControlList35.setupTestData(FLAT_RATE -> '0')).right.value.controlList should contain(FlatRate)
          tryParse(ControlList35.setupTestData(FLAT_RATE -> '1')).right.value.controlList should not contain FlatRate
        }
        ...
        "parse pending oa correctly" in {
          ...
          tryParse(ControlList35.setupTestData(PENDING_OA -> '0')).right.value.controlList should contain(PendingOA)
          tryParse(ControlList35.setupTestData(PENDING_OA -> '1')).right.value.controlList should not contain PendingOA
        }

        "parse Hidden Economy correctly" in {
          tryParse(ControlList35.setupTestData(HIDDEN_ECONOMY -> '0')).right.value.controlList should contain(HiddenEconomy)
          tryParse(ControlList35.setupTestData(HIDDEN_ECONOMY -> '1')).right.value.controlList should not contain HiddenEconomy
        }
      }
    }
    ...
    "fail and return InvalidFormat" when {
      "the string is not 33 or 34 characters long" in {
        tryParse(ControlList34.valid.drop(1)) shouldBe Left(InvalidFormat)
      }
      "the string does not represent a binary number" in {
        ...
        tryParse(ControlList35.valid.replaceFirst("1", "2")) shouldBe Left(InvalidFormat)
      }
    }
    "fail and return StaggerConflict" when {
      "multiple stagger is defined" in {
        ...
        tryParse(ControlList35.staggerConflict) shouldBe Left(StaggerConflict)
      }
    }
  }
