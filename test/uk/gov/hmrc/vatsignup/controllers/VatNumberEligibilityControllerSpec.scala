...
class VatNumberEligibilityControllerSpec extends WordSpec
  with Matchers
  with MockAuthConnector
  with MockControlListEligibilityService {

  object TestVatNumberEligibilityController
    extends VatNumberEligibilityController(mockAuthConnector, mockControlListEligibilityService, stubControllerComponents())
