...
class CtReferenceLookupControllerSpec
  extends WordSpec with Matchers with MockAuthConnector with MockCheckCtReferenceExistsService with MockGetCtReferenceConnector {

  object TestCtReferenceLookupController extends CtReferenceLookupController(mockAuthConnector, mockCheckCtReferenceExistsService, stubControllerComponents())
