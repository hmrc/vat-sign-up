...
class StoreGovernmentOrganisationControllerSpec extends WordSpec with Matchers with MockAuthConnector with MockStoreGovernmentOrganisationService {
  ...
  "storeGovernmentOrganisation" when {
    "is successful" should {
      "return NO_CONTENT" in {
        ...
        val result = TestStoreGovernmentOrganisationController.storeGovernmentOrganisation(testVatNumber)(FakeRequest())
