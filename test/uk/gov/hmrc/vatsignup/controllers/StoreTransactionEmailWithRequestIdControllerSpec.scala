...
class StoreTransactionEmailWithRequestIdControllerSpec extends UnitSpec with MockAuthConnector with MockStoreEmailWithRequestIdService {

  object TestStoreTransactionEmailController extends StoreTransactionEmailWithRequestIdController(mockAuthConnector, mockStoreEmailWithRequestIdService)
