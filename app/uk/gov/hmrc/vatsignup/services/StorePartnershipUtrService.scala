...
import uk.gov.hmrc.vatsignup.services.StorePartnershipUtrService._

import scala.concurrent.{ExecutionContext, Future}


@Singleton
class StorePartnershipUtrService @Inject()(subscriptionRequestRepository: SubscriptionRequestRepository)
  ...
  def storePartnershipUtr(vatNumber: String,
    ...
    subscriptionRequestRepository.upsertPartnershipUtr(vatNumber, partnershipEntityType, partnershipUtr) map {
...
object StorePartnershipUtrService {
