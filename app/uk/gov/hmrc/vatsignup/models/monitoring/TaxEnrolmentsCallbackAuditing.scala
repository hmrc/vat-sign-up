...
object TaxEnrolmentsCallbackAuditing {
  val taxEnrolmentsCallbackTransactionName = "TaxEnrolmentsCallback"
  val taxEnrolmentsCallbackAuditType = "TaxEnrolmentsCallback"
  ...
  case class TaxEnrolmentsCallbackAuditModel(vatNumber: String,
    ...
    override val detail: Map[String, String] = Map(
      "vatNumber" -> vatNumber,
      "taxEnrolmentsCallback" -> taxEnrolmentsCallback
    )
